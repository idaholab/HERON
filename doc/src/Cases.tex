...
\subsection{Case}
  ...
  \begin{itemize}
    ...
    \item \xmlNode{num_arma_samples}:\xmlDesc{integer}, 
      -- no description yet --

    \item \xmlNode{timestep_interval}:\xmlDesc{integer}, 
      -- no description yet --

    \item \xmlNode{history_length}:\xmlDesc{integer}, 
      -- no description yet --
    ...
    \item \xmlNode{dispatch_increment}:\xmlDesc{float}, 
      -- no description yet --
      The \xmlNode{dispatch_increment} node recognizes the following parameters:
        \begin{itemize}
