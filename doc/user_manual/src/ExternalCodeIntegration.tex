...
\begin{lstlisting}[style=XML,morekeywords={class}]
<economics lifetime="30">
  <CashFlow inflation="none" name="capex" taxable="TRUE" type="one-time"></CashFlow>
  <CashFlow inflation="none" name="FOM" taxable="TRUE" type="repeating"></CashFlow>
  <CashFlow inflation="none" name="VOM" taxable="TRUE" type="repeating"></CashFlow>
</economics>
\end{lstlisting}
\end{minipage} \par
