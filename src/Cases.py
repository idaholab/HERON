  ...
  def get_input_specs(cls):
    ...
    input_specs.addSub(
        InputData.parameterInputFactory(
            ...
            descr=r"""provides the number of synthetic histories that should be
            considered per system configuration in order to obtain a reasonable
            representation of the economic metric. Sometimes referred to as
    ...
    time_discr.addSub(
        InputData.parameterInputFactory(
            ...
            descr=r"""name for the \texttt{time} variable used in this simulation.
            \default{time}"""
        )
    )
    time_discr.addSub(
        InputData.parameterInputFactory(
            'year_variable',
            contentType=InputTypes.StringType,
            descr=r"""name for the \texttt{year} or \texttt{macro} variable used
            in this simulation. \default{Year}"""
        )
    )
    time_discr.addSub(
        InputData.parameterInputFactory(
    ...
    # validator
    validator = InputData.parameterInputFactory(
        'validator',
        ordered=False,
