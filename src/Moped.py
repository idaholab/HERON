        ...
        for cf, value in cf_meta.items():
            if cf == 'Lifetime':
                ...
                if capex_driver is None:
                    ...
                    capex = self.createCapex(component, value, capex_driver)
                cfs.append(capex)
            ...
            # Necessary to avoid error message from expected inputs
            elif cf in ['Deprec', 'Capex Driver', 'Yearly Driver', 'Dispatch Driver']:
                continue
            elif cf == 'Yearly':
                ...
                if yearly_driver is None:
                    ...
                    yearly = self.createRecurringYearly(component, value, yearly_driver)
                cfs.append(yearly)
            elif cf == 'Dispatching':
