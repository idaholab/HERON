  ...
  def get_input_specs(cls):
    ...
    spec = InputData.parameterInputFactory('ratio', contentType=InputTypes.StringType,
        descr=r"""indicates this transfer function is a constant linear combination of resources. For example,
              (3a, 7b, -2c) means that the ratio of (3, 7, -2) must be maintained between (a, b, c) for all
              production levels. For an equation-based transfer function instead of balance ratio, see Polynomial.""")
