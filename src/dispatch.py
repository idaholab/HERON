...
#sys.path.append(os.path.expanduser('/Users/gaira/Desktop/myHeron/egret/src'))
...
#raven_path = os.path.abspath(os.path.expanduser('/Users/gaira/Desktop/myHeron/egret/raven/framework'))
...
#sys.path.append(os.path.expanduser('/Users/gaira/Desktop/myHeron/egret')) #/CashFlow/src'))
